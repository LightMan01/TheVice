...
local function SpawnVehicle(model, x, y, z, heading, ped)
	...
	if IsModelValid(model) then
		...
		TriggerServerEvent('DiscordBot:ToDiscord', 'system', 'WSRP Log | Vehicles', '```css\n'..playerName..' взял '..name..' \n```', 'https://wiki.gtanet.work/images/a/ae/FMJ.png', true)

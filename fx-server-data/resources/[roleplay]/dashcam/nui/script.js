const Dashcam = new Vue({
    ...
    data: {
        ...
        dashMessageOne: "Этот транспорт лицензирован",
        dashLabel: "Штатом Сан-Андреас",
        dashMessageTwo: "Любое незарегистрированное пользование субьектом грозит наказанием по статье 13 S.A. Pen. Code 502(a)."
    },

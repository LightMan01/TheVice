...
emotes['coffee'] = {name = 'coffee', anim = 'WORLD_HUMAN_AA_COFFEE'}
emotes['citation'] = {name = 'citation', anim = 'CODE_HUMAN_MEDIC_TIME_OF_DEATH'}
emotes['notes'] = {name = 'notes', anim = 'WORLD_HUMAN_CLIPBOARD'}
emotes['traffic'] = {name = 'traffic', anim = 'WORLD_HUMAN_CAR_PARK_ATTENDANT'}
emotes['stop'] = {name = 'stop', anim = 'WEAPON_UNARMED'}
emotes['party'] = {name = 'party', anim = 'WORLD_HUMAN_PARTYING'}
emotes['weed'] = {name = 'weed', anim = 'WORLD_HUMAN_SMOKING_POT'}
emotes['holster'] = {name = 'holster', anim = 'intimidation'}
...
RegisterCommand('showEmotes', function(source, args)
	TriggerEvent('chatMessage', "^2Emotes", {255, 0, 0}, " (Example: /a sit)")
	local emoteslist = ""
